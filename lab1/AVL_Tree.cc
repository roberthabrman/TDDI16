...
node_height(const Node_Pointer p)
{
...
void
AVL_Tree_Node<Comparable>::
calculate_height(const Node_Pointer p)
{
...
void
AVL_Tree_Node<Comparable>::
single_rotate_with_left_child(Node_Pointer& k2)
{
...
void
AVL_Tree_Node<Comparable>::
single_rotate_with_right_child(Node_Pointer& k1)
{
...
void
AVL_Tree_Node<Comparable>::
double_rotate_with_left_child(Node_Pointer& k3)
{
...
void
AVL_Tree_Node<Comparable>::
double_rotate_with_right_child(Node_Pointer& k3)
{
...
AVL_Tree_Node<Comparable>*
AVL_Tree_Node<Comparable>::
find(const Comparable& x, const Node_Pointer t)
{
	if (t == nullptr)
		return nullptr;
	else if (x < t->element)
...
template<typename Comparable>
void
AVL_Tree_Node<Comparable>::remove(const Comparable& x, Node_Pointer& t)
{

	cerr << "HEJHOPP" << endl;
	if (t == nullptr)
	{
		return;  //trädet är tomt? Här kan ett undantag genereras i stället ...
	}
	...
	if (t != nullptr && (node_height(t->left) - node_height(t->right) == 2))
	{
		/*if(node_height((t->left)->left) - node_height(t->right->right) < 0))
			double_rotate_with_left_child(t->left);
		else*/
		if (t->left != nullptr && (node_height((t->left)->right) == node_height((t->left)->left)))
			single_rotate_with_left_child(t->left);


		else if (t->left != nullptr && (  (node_height((t->left)->right) - node_height((t->left)->left)) == 1))
			//((t->left)->right)-node_height((t->left)->left))=1))
			double_rotate_with_left_child(t);
		else
			single_rotate_with_left_child(t);
	...
	if (t != nullptr && (node_height(t->right) - node_height(t->left) == 2))
	{
		if (t->right != nullptr && (node_height((t->right)->left) == node_height((t->right)->right)))
			single_rotate_with_right_child(t);

		else if (t->right != nullptr && (  (node_height((t->right)->left) - node_height((t->right)->right)) == 1))
			//((t->left)->right)-node_height((t->left)->left))=1))
			double_rotate_with_right_child(t);
		else
			single_rotate_with_right_child(t);
...
template<typename Comparable>
AVL_Tree<Comparable>::
AVL_Tree(const AVL_Tree& value) : root(Node::clone(value.root))
{
}
...
AVL_Tree<Comparable>&
AVL_Tree<Comparable>::
operator=(AVL_Tree<Comparable> rhs)
{
	swap(rhs);
	return *this;
}
...
{
	cout << "Remove körs" << endl;
	Node::remove(x, root);
	/*if (t == nullptr)
	{
	  return;  // Här kan ett undantag genereras i stället ...??throw AVL_Tree_error??
	}
...
void
AVL_Tree<Comparable>::
swap(AVL_Tree<Comparable>& other)
{
